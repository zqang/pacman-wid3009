...
public class AStarSearchPacMan extends Controller<MOVE> {
    private static Controller<EnumMap<Constants.GHOST, MOVE>> ghostMoves;
    ...
    public MOVE bestMoveByAStar(Game game) {
        ...
        //return null;
        MOVE bestMove = bestMoveFunction(game);
        return bestMove;
    }

    private MOVE bestMoveFunction(Game game) {
